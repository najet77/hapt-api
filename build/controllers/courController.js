...
var _cour = require("../models/cour");

var _cour2 = _interopRequireDefault(_cour);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            cour = new _cour2.default(req.body);
            _context.next = 4;
            return client.save().then(function (newCour) {
              return newCour;
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _cour2.default.find().populate({ path: "students", model: "User", select: "-password" }).populate("formations");

          case 3:
            cours = _context2.sent;
            return _context2.abrupt("return", res.status(200).json(cours));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _cour2.default.findById(req.params.courId).populate({ path: "students", model: "User", select: "-password" }).populate("formations");
          ...
          case 6:
            return _context3.abrupt("return", res.status(200).json(cour));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _cour2.default.findByIdAndUpdate(req.params.courId, { $set: req.body }, { new: true });
          ...
          case 6:
            return _context4.abrupt("return", res.status(200).json(cour));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _cour2.default.findByIdAndRemove(req.params.courId);
          ...
          case 6:
            return _context5.abrupt("return", res.status(204).json({ message: "Cour deleted successfully!" }));
