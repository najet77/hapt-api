...
var _formation = require("../models/formation");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            formation = new _formation2.default(req.body);
            _context.next = 4;
            return client.save().then(function (newFormation) {
              return newFormation;
            });

          case 4:
            formation = _context.sent;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _formation2.default.find().populate("cours");

          case 3:
            formations = _context2.sent;
            return _context2.abrupt("return", res.status(200).json(formations));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _formation2.default.findById(req.params.formationId).populate("cours");
          ...
          case 6:
            return _context3.abrupt("return", res.status(200).json(formation));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _formation2.default.findByIdAndUpdate(req.params.formationId, { $set: req.body }, { new: true });

          case 3:
            formation = _context4.sent;
          ...
          case 6:
            return _context4.abrupt("return", res.status(200).json(formation));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _formation2.default.findByIdAndRemove(req.params.formationId);

          case 3:
            formation = _context5.sent;
          ...
          case 6:
            return _context5.abrupt("return", res.status(204).json({ message: "Formation deleted successfully!" }));
